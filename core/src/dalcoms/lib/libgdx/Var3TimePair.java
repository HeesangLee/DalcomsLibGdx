...
public class Var3TimePair implements Cloneable {
    private float variation1 = 0f, variation2 = 0f, variation3 = 0f, time = 0f;

    public Var3TimePair() {

    }

    public Var3TimePair(float var1, float var2, float var3, float time) {
    ...
    public String toString() {
        return "((" + String.valueOf(getVariation1()) + ", " + String.valueOf(getVariation2()) +
               ", " + String.valueOf(getVariation3()) + ")," + String.valueOf(getTime()) + ")";
    }
}
